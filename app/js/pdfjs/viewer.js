...
function scrollIntoView(element, spot, skipOverflowHiddenElements) {
  ...
  while (parent.tagName.toLowerCase() != 'body') { // MH CDL: Had to change scrolling because I'm not using abs positioning
    ...
    parent = parent.parentElement; // MH CDL: was: parent.offsetParent;
    if (!parent) {
      return; // no need to scroll
    }
  }
  offsetY -= 180; // MH CDL: Total hack, because numbers weren't coming out right
  if (spot) {
...
var PDFViewerApplication = {
  ...
  isViewerEmbedded: true, // MH CDL: this was getting false, resulting in initial scroll to top of PDF (bad). Really hard to trace down.
  url: '',
  ...
  setInitialView: function pdfViewSetInitialView(storedHash, options) {
    ...
    this.pdfViewer.suppressScroll = this.isViewerEmbedded; // MH CDL: It is evil to scroll when embedded
    ...
    this.pdfViewer.suppressScroll = false // MH CDL
  },
