          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <input type="number" id="pageNumber" className="toolbarField pageNumber" value="1" size="4" min="1" tabIndex="15" />
      ...
      <div id="overlayContainer" className="hidden">
        <div id="passwordOverlay" className="container hidden">
          <div className="dialog">
            ...
            <div className="row">
              <input id="password" className="toolbarField" />
            </div>
