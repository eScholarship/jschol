  ...
  render() {
    return (
      <div>
        ...
        <h2>Heading Style 2a</h2>
        <h5 className="o-heading2a">From the New Heights: The City and Migrating Latinas in Real Women Have Curves and María Full of Grace</h5>
        ...
        <h2>Heading Style 5</h2>
        <h3 className="o-heading4a">From the New Heights: The City and Migrating Latinas in Real Women Have Curves and María Full of Grace</h3>
