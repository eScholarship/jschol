  ...
  render() {
    ...
    return (
      <FormComp to="/search" className="c-search1">
        ...
        <input type="search" id="c-search1__field" name="q" className="c-search1__field" placeholder={`Search more than ${(Math.floor(this.props.statsCountItems / 10000) * 10000).toLocaleString()} items`} defaultValue={q} autoCapitalize="off" />
        {filters}
