  ...
  render() {
    return (
      <div className="c-tabcontent">
        <h1 className="c-tabcontent__main-heading" tabIndex="-1">Comments content to go here</h1> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea praesentium laudantium est provident. Aspernatur adipisci, nisi error molestias consectetur ipsum saepe magni nemo! Inventore esse nostrum omnis accusamus, veritatis at.
      </div>
    )
  }
}
